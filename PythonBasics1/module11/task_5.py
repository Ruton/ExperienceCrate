...
earth_volume = 10.8321 * math.pow(10, 11)
planet_radius = float(input('Введите радиус случайной планеты: '))
planet_volume = 4 / 3 * math.pi * math.pow(planet_radius, 3)
comparsion_result = round(earth_volume / planet_volume, 3)

if comparsion_result < 1:
    adjust_result = round(1 / comparsion_result, 3)
    print(f'Объём планеты Земля меньше в (1/{comparsion_result})',
          '=', adjust_result, 'раз')
elif comparsion_result == 1:
    print('Объемы планет совпадают')
else:
    print(f'Объём планеты Земля больше в {comparsion_result} раз')
