...
for _ in range(numbers_count):
    ...
    if number >= 0:
        estimate = math.ceil(number)
        calculation = math.log(estimate)
        print(f'x = {estimate}\tlog(x) = {calculation}\n')
    else:
        estimate = math.floor(number)
        calculation = math.exp(estimate)
        print(f'x = {estimate}\texp(x) = {calculation}\n')
