...
playerDice = int(input('Кубик Кости: '))
hostDice = int(input('Кубик владельца: '))

if playerDice >= hostDice:
  print('Разница:', playerDice - hostDice)
  print('Костя платит')

else:
  print('Сумма:', playerDice + hostDice)
