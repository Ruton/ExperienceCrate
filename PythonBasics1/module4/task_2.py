...
russianPoints = int(input('Введите кол-во баллов по русскому языку: '))
mathPoints = int(input('Введите кол-во баллов по математике: '))
itPoints = int(input('Введите кол-во баллов по информатике: '))

total = russianPoints + mathPoints + itPoints
